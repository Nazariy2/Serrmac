...
function _getBlog() {
  _getBlog = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
...
function _createPost() {
  _createPost = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data) {
    var post, getAnswer, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
...
form.addEventListener("submit", function (event) {
  ...
  var Nome_Cognome = form.elements.title.value;
  var Nome_Rivenditore = form.elements.author.value;
  var Modello_Macchina = form.elements.Modello.value;
  var Matricola = form.elements.Matricola.value;
  var Anno_di_Produzione = form.elements.Anno.value;
  var Data_Inserimento = form.elements.inserimento.value;
  var Data_di_Intervento = form.elements.intervento.value;
  var Nome_Responsabile = form.elements.responsabile.value;
  ...
  var postData = {
    ...
    Matricola: Matricola,
    Anno_di_Produzione: Anno_di_Produzione,
    Data_Inserimento: Data_Inserimento,
    Data_di_Intervento: Data_di_Intervento,
